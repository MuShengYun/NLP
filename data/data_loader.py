import emoji#y引入绘文字
import nltk #引入NLP自然语言处理库
from ekphrasis.classes.preprocessor import TextPreProcessor#使用专对社交网络的文本预处理工具，你可以通过textPreProcessor轻松地定义一个预处理管道。
from ekphrasis.classes.tokenizer import SocialTokenizer#一个瞄准社交网络的实体识别器应该能够理解复杂的情感符号，表情和其他一些结构化的表述例如日期、时间等等
from ekphrasis.dicts.emoticons import emoticons#表情符号
